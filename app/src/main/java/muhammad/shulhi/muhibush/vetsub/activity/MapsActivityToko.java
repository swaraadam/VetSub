...
public class MapsActivityToko extends FragmentActivity implements OnMapReadyCallback , GoogleMap.OnInfoWindowClickListener{

    private GoogleMap mMap;
    private static final int LOCATION_PERMISSION = 500;
    private List<Toko> mTokoList = new ArrayList<>();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (ActivityCompat.checkSelfPermission(MapsActivityToko.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED &&
                ActivityCompat.checkSelfPermission(MapsActivityToko.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(MapsActivityToko.this,new String[]{Manifest.permission.ACCESS_FINE_LOCATION},LOCATION_PERMISSION);
        ...
        ApiServices.service_get.petcare_getall().enqueue(new Callback<ArrayList<Toko>>() {
            ...
            public void onFailure(Call<ArrayList<Toko>> call, Throwable t) {
                Toast.makeText(MapsActivityToko.this,"Mohon maaf terjadi gangguan dengan jaringan Anda", Toast.LENGTH_SHORT).show();
            }
        });
